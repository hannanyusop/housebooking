                                ...
                                <div class="table-responsive product-table">
                                    <table class="display table-sm" id="datatable">
                                        ...
                                        <?php while($data = $result->fetch_assoc()){ ;?>
                                            <?php
                                            $not_claim_q = $db->query("SELECT * FROM voucher_claims WHERE voucher_id='$data[id]' AND agent_id IS NULL");
                                            $not_claims_count = $not_claim_q->num_rows;

                                            $total_q = $db->query("SELECT * FROM voucher_claims WHERE voucher_id='$data[id]'");
                                            $num_total_q = $total_q->num_rows;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="voucher-view.php?id=<?= $data['id']; ?>" class="btn btn-success btn-xs">View Ticket</a>
