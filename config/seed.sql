...
DROP DATABASE IF EXISTS `booking_house`;
...
INSERT INTO `agents` (`id`, `is_active`, `email`, `password`, `name`, `phone_number`, `total_point`, `point`, `rank`) VALUES
	(1, 1, 'agent@mail.com', '$2y$10$DBx1sWe3Zj7juZ7yoNIx3.oxJZnaodu5aQyoVoCVhySiMdRpkUlCm', 'AGENT ACCOUNT', '0123456789', 0, 0, 'junior'),
	(2, 1, 'dokijud@mailinator.com', '$2y$10$8fv2qdP543kXf/8Xdu9tbOlaFUZLf5Jz2Ei.ZKg/PjevaNRdaKivm', 'Grant Huber', '', 0, 0, 'senior'),
	(3, 1, 'bugagykytu@mailinator.com', '$2y$10$nseP4vXnqoAU9yE1LGfKkuuN4rRbjFiwYN9b1MaHreqwhSeoOSuJm', 'Charity Rocha', '+1 (605) 292-4092', 0, 0, 'senior');
...
-- Dumping data for table booking_house.bookings: ~0 rows (approximately)
...
INSERT INTO `customers` (`id`, `email`, `password`, `name`, `phone_number`, `approved_at`) VALUES
	(2, 'customer@mail.com', '$2y$10$DBx1sWe3Zj7juZ7yoNIx3.oxJZnaodu5aQyoVoCVhySiMdRpkUlCm', 'CUSTOMER ACCOUNT', '012345546', NULL);
...
-- Dumping data for table booking_house.projects: ~0 rows (approximately)
/*!40000 ALTER TABLE `projects` DISABLE KEYS */;
INSERT INTO `projects` (`id`, `name`, `location_coordinate`, `location_name`, `start`, `end`, `status`) VALUES
	(2, 'Herman Raymond', 'Eum dolore sunt est ', 'Blanditiis quaerat n', '2021-04-06', '2021-04-30', 2);
